...
└── system-prompts/               # 1,388 markdown files (Claude Code v2.1.202)
```
...
- **Claude Code:** built for v2.1.202 (the latest release). Per-prompt `ccVersion:` frontmatter records when each prompt last changed. Upgrade playbook: [UPGRADE.md](UPGRADE.md).
