...
└── system-prompts/               # 2,462 markdown files (Claude Code v2.1.220)
```
...
- **Claude Code:** built for v2.1.220 (the latest release). Per-prompt `ccVersion:` frontmatter records when each prompt last changed. Upgrade playbook: [UPGRADE.md](UPGRADE.md).
