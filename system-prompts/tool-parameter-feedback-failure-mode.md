<!--
name: 'Tool Parameter: Feedback failure mode'
description: >-
  Describes the feedback report's failure_mode field for model-behavior issues
  and when to omit it for a pure product bug.
ccVersion: 2.1.231
-->
