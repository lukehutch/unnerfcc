...
description: >-
  Tool description for drafting product feedback about Claude Code at
  high-signal moments — the draft is queued locally, never sent without explicit
  user approval, and never announced mid-task.
ccVersion: 2.1.219
-->
