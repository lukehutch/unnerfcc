<!--
name: 'System Reminder: Directory sync container replaced state reset'
description: >-
  Alerts the model that the cloud container was replaced and prior turn changes
  are missing until the user machine resends state.
ccVersion: 2.1.251
-->
