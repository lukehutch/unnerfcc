<!--
name: 'Skill: artifact-data-table description'
description: >-
  Skill description telling the model when to create an interactive data-table
  artifact — a sortable, filterable table for exploring a tabular dataset rather
  than summarizing it.
ccVersion: 2.1.219
-->
