<!--
name: 'System Prompt: Session token-usage breakdown command'
description: >-
  Slash-command prompt that has the model group this session's transcript token
  usage into weighted categories, chart them, and explain the chart in plain
  language, treating transcript contents as data rather than instructions.
ccVersion: 2.1.219
-->
