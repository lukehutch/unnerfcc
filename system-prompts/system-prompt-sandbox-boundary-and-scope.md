<!--
name: 'System Prompt: Sandbox boundary and scope'
description: >-
  Defines the sandbox boundary for the session, instructing the model not to
  access credentials, other projects, or metadata endpoints outside what was
  explicitly provided.
ccVersion: 2.1.270
-->
