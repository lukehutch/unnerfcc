<!--
name: 'Tool Description: DesignSync methods and workflow'
description: >-
  Details the read, setup, plan boundary, and write methods for the DesignSync
  tool, including security constraints on fetched files.
ccVersion: 2.1.272
-->
