<!--
name: 'Skill: Cost-Reduction Search'
description: >-
  Guidance for structuring and executing an eval-driven search to reduce Claude
  API spend through caching checks, prompt auditing, model-effort staircase
  walks, and prompt hillclimbing.
ccVersion: 2.1.263
-->
