...
description: >-
  design-sync skill reference shown when .storybook/ is found: component
  bundling, preview generation from story sources, and matching against
  Storybook reference renders.
ccVersion: 2.1.251
-->
