<!--
name: 'Skill: artifact-components description'
description: >-
  Skill-listing description for the artifact-components skill — embedding
  reusable components (first entry: the workshop decision component) in any HTML
  artifact, and looking up a component's scripts, styles, markup contract, and
  composition limits.
ccVersion: 2.1.251
-->
