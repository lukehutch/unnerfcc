<!--
name: 'Skill: artifact-dashboard description'
description: >-
  Skill description telling the model when to create a dashboard artifact of KPI
  tiles, a primary time-series chart, and a breakdown table.
ccVersion: 2.1.251
-->
