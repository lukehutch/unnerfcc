<!--
name: 'Skill: prototype when_to_use (offer unprompted)'
description: >-
  Prototype skill when_to_use guidance telling the model to offer a prototype at
  most once per session as one short line while the user is still weighing a new
  product or UI idea, building it only on a yes and never offering again after a
  no.
ccVersion: 2.1.222
-->
