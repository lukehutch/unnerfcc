<!--
name: 'Skill: workshop artifact HTML template'
description: >-
  Bundled workshop-artifact page shell for the workshop skill's rendered publish
  path — the {{TAB_TITLE}}/{{EYEBROW}}/{{TITLE}}/{{SUMMARY}} + section-run
  HTML/CSS scaffold that renderWorkshopArtifact fills mechanically, carrying the
  vendored @ant/cds token block, the data-theme to data-mode mirror script, the
  ws-status-banner, ws-decisions island and ws-status-footer fill points, and
  the hash-pinned decisions script that arms the option rows and republishes the
  page when the reader confirms.
ccVersion: 2.1.232
-->
<!--
name: workshop
