<!--
name: 'Tool Description: ScheduleWakeup — picking delaySeconds (5-minute cache TTL)'
description: >-
  delaySeconds guidance for sessions on the default 5-minute prompt-cache TTL —
  stay under 300s while actively polling, commit to 1200s+ otherwise, and never
  pick exactly 300s.
ccVersion: 2.1.219
-->
