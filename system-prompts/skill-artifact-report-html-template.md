...
description: >-
  Bundled template.html body fragment for the artifact-report skill — inlined
  CDS token literals with dark and print scopes, serif masthead, table of
  contents, prose sections and optional appendix, plus a TOC-rebuild script that
  never degrades below the static list.
ccVersion: 2.1.219
-->
