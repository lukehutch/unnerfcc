...
description: >-
  Field description requiring the report as labeled bullets — what happened,
  what the user said, repro, evidence, and an optional verified cause — with no
  narrative, speculation, or secrets.
ccVersion: 2.1.251
-->
