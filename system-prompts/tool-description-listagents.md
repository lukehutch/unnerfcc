...
description: >-
  Model-facing description of the ListAgents tool listing addressable subagents,
  teammates, and local/cloud/remote sessions, the one-way limit on cloud
  sessions, and how to address messages to them.
ccVersion: 2.1.251
variables:
