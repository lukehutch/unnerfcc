<!--
name: 'Tool Description: Artifact format requirements'
description: >-
  Instructs Claude to author artifacts as HTML pages unless a loaded skill
  explicitly requests Markdown.
ccVersion: 2.1.272
-->
