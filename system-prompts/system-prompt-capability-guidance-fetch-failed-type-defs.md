...
variables:
  ...
  - TYPE_DEFS_FILENAME
-->
**`${CAPABILITY_NAME}`.** Its authoring guidance could not be fetched this invocation; its type definitions are extracted at `${EXTRACT_DIR}/${TYPE_DEFS_FILENAME}` — Read that file before 
