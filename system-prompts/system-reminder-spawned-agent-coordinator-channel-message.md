<!--
name: 'System Reminder: Coordinator channel message context'
description: >-
  Labels a participant message relayed from the coordinator session's messaging
  channel as background context.
ccVersion: 2.1.263
-->
