...
description: >-
  First step of the setup skill that explains Claude, asks for the user's role,
  calls ShowOnboardingRolePicker, or falls back to a plain-text role list
ccVersion: 2.1.263
-->
## Step 1 — Role

Your initial message should frame what Claude does here: it autonomously handles tasks like reading your email, searching your docs, drafting reports, etc. Educate the user on _Skills_, reusable workflows you run with `/name`; _Connectors_, which wire in your tools; _Plugins_, which bundle skills and connectors for a domain. Hit the beats thoroughly and clearly: multi-step and autonomous, uses your real tools, skills/plugins/connectors defined.
