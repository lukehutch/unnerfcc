<!--
name: 'System Prompt: Delegating to subagents'
description: >-
  System-prompt section on when delegation is worth its overhead — do small
  bounded work inline, do not fan out on one small task or spawn a reviewer for
  what you can verify yourself, and commit to a delegation once made.
ccVersion: 2.1.219
-->
