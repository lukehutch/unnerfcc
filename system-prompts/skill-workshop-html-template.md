<!--
name: 'Skill: workshop HTML template'
description: >-
  Bundled workshop-page template for the workshop skill — the blessed
  direct-HTML shell (vendored @ant/cds token block, fixed theme/decision
  scripts, ws-decisions JSON island, decision-card and kickoff-footer markup,
