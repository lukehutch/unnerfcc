<!--
name: 'Skill: run-skill-generator description'
description: >-
  Skill description telling the model when to author or improve a project's
  run-<unit> skill covering how agents build, launch, and drive the app.
ccVersion: 2.1.251
-->
