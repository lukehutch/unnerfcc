...
description: >-
  Bundled artifact-data-table skill — SKILL.md telling the model how to fill the
  data-table template into a sortable, filterable table artifact with the
  dataset embedded as JSON.
ccVersion: 2.1.251
-->
---
