<!--
name: 'Skill: Code Review (minimal prompt)'
description: >-
  Minimal code-review prompt — gather the diff, make one careful senior-engineer
  pass for correctness bugs, submit at most 15 findings via the findings tool,
  and restate them in the final reply.
ccVersion: 2.1.219
variables:
