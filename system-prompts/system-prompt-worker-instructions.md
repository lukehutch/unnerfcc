...
4. **Commit and push** — ${COMMIT_INSTRUCTION}, push the branch, and create a PR${PR_ARGUMENTS}. Use a descriptive title. If `gh` is not available or the push fails, note it in your final message.
