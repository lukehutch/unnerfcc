...
description: >-
  Names a coding session so the user can pick it out of a long list — a short
  noun-phrase title led by the most specific thing the user named, written in
  the user's own language and taken from the session content as data rather than
  instructions.
ccVersion: 2.1.235
-->
