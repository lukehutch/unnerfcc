<!--
name: 'System Reminder: Directory sync working directory empty'
description: >-
  Informs the model that directory sync has not checked in and the working
  directory is empty, advising it not to create files yet.
ccVersion: 2.1.277
-->
