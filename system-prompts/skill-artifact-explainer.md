...
description: >-
  Bundled artifact-explainer skill — SKILL.md telling the model how to fill the
  explainer template into a step-by-step teaching artifact with a lede, numbered
  steps or sections, and a recap.
ccVersion: 2.1.251
-->
---
