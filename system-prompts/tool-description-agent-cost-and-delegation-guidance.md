<!--
name: 'Tool Description: Agent cost and delegation guidance'
description: >-
  Provides detailed guidance on the token and coordination costs of spawning
  agents, when to delegate vs do inline work, and how to write effective agent
  briefs.
ccVersion: 2.1.272
-->
