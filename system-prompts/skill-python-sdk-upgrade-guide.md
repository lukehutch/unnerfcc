<!--
name: 'Skill: Python SDK Upgrade Guide'
description: >-
  Step-by-step instructions for upgrading the anthropic Python SDK from 0.x to
  1.x, covering Python floor, httpx2 migration, raw responses, removed
