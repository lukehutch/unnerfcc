<!--
name: 'Tool Parameter: Artifact page language'
description: >-
  lang parameter of the artifact publish tool — the BCP-47 tag of the page's
  text content, required on every publish.
ccVersion: 2.1.251
-->
