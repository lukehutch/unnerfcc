<!--
name: 'Skill: artifact-components decision-component skeleton'
description: >-
  Bundled decision-component skeleton for the artifact-components skill — one
  complete .call-item decision block plus its ws-decisions island entry,
  carrying the id grammar, the state/opts/choice lockstep, and the
  byte-identical script placement the publish verifier enforces.
ccVersion: 2.1.232
-->
