<!--
name: 'Skill: /init CLAUDE.md and skill setup (phases 2-8)'
description: >-
  Continuation of the /init skill after the agent-config presence check —
  codebase detection, the AskUserQuestion interview, proposal refinement,
  skill/hook authoring, and the closing summary with follow-up suggestions.
ccVersion: 2.1.219
-->
