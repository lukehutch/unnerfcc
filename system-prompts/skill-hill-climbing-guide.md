<!--
name: 'Skill: Hill-climbing guide'
description: >-
  Step-by-step instructions for iteratively improving a Claude-powered app
  against a fixed eval across failure analysis, prompt/code modifications, and
  held-out test set scoring
ccVersion: 2.1.263
-->
