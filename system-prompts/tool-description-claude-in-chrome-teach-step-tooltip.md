<!--
name: 'Tool Description: Claude in Chrome teach step'
description: >-
  Describes the teach_step tool that shows one guided-tour tooltip, runs its
  actions on Next, and returns a fresh screenshot.
ccVersion: 2.1.219
-->
