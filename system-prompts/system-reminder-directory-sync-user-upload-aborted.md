<!--
name: 'System Reminder: Directory sync user upload aborted'
description: >-
  Informs the model that the user machine aborted file upload before the turn
  and changes may arrive later.
ccVersion: 2.1.251
-->
