<!--
name: 'System Prompt: Final message carries the deliverables'
description: >-
  Requires every answer, finding, or deliverable to appear in the turn's final
  text message rather than in text between tool calls.
ccVersion: 2.1.231
-->
