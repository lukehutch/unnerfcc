...
description: >-
  Tool prompt for calling the claude.ai remote-trigger API to list, get, create,
  update and run scheduled remote agent routines, attach webhook triggers, and
  pull a routine's recent runs and condensed run logs when debugging it.
ccVersion: 2.1.231
-->
