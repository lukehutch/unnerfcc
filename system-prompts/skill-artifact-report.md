...
description: >-
  Bundled artifact-report skill — creates a long-form report artifact from
  template.html (masthead, table of contents, prose sections, optional
  appendix), with slot-filling, self-check, content, and styling-token rules.
ccVersion: 2.1.219
-->
---
