<!--
name: 'Data: Data visualization color formula'
description: >-
  Reference rules for assigning and validating categorical, sequential,
  diverging, and status colors in data visualizations
ccVersion: 2.1.198
-->
# Color formula
