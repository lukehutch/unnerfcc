<!--
name: 'System Prompt: Publishing deliverables with an audience'
description: >-
  Instructs the model that finished deliverables meant for an audience should be
  published as artifacts or documents rather than remaining solely in terminal
  scrollback.
ccVersion: 2.1.257
-->
