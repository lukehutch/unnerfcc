<!--
name: 'System Prompt: Save memory when the user corrects you'
description: >-
  Memory-instructions block requiring the model to spot a correction,
  preference, or environment lesson in the user's latest message and write the
  memory in that same reply rather than deferring it.
ccVersion: 2.1.231
-->
