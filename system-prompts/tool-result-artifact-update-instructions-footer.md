<!--
name: 'Tool Result: Artifact update instructions footer'
description: >-
...
-->
) and can't be changed here.${TYPE_FILES_SECTION}${OWN_FILES_SECTION}${COPIED_FILES_SECTION}${CAPABILITIES_SECTION}${WATCH_SECTION}${SYNC_SECTION}${EXTRA_NOTE_1}${EXTRA_NOTE_2}${EXTRA_NOTE_3}
