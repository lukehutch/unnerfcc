<!--
name: 'System Reminder: Settings sync pending'
description: >-
  Informs the model that user settings (CLAUDE.md, permissions, preferences)
  have not landed yet and the session is running on default settings.
ccVersion: 2.1.251
-->
