<!--
name: 'Tool Description: Chrome navigate (tab handling)'
description: >-
  Describes the browser navigate tool and when a tabId may be omitted versus
  when it must be passed explicitly.
ccVersion: 2.1.219
-->
