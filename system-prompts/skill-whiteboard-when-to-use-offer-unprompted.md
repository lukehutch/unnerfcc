<!--
name: 'Skill: whiteboard (offer it unprompted)'
description: >-
  Whiteboard skill when_to_use guidance telling the model to offer a sketch at
  most once per session for architecture questions, multi-component plans, or
  repeated clarifying questions, making the offer one short line and dropping it
  on a no or no answer.
ccVersion: 2.1.219
-->
