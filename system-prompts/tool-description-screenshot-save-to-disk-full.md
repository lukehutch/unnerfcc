<!--
name: 'Tool Description: Screenshot save_to_disk Param (Full)'
description: >-
  screenshot save_to_disk param: save the image to disk to attach to a message;
  only when intending to share
ccVersion: 2.1.178
-->
