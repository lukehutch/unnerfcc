...
description: >-
  Bundled artifact-dashboard skill — SKILL.md telling the model how to fill the
  dashboard template (KPI tiles, primary time-series chart, breakdown table)
  into an operational metrics artifact.
ccVersion: 2.1.251
-->
---
