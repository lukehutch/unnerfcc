<!--
name: 'System Reminder: Scheduled task turn'
description: >-
  Marks the turn as started by the scheduler rather than the user, and defines
  how far the schedule's attestation goes.
ccVersion: 2.1.219
variables:
