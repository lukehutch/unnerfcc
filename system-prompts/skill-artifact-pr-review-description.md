...
description: >-
  Skill description for creating a PR review artifact — a structured review
  briefing published as a shareable page — noting that it is not a narrative
  walkthrough and that edits to an existing artifact modify its HTML directly.
ccVersion: 2.1.231
-->
