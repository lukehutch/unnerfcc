<!--
name: 'Agent Prompt: Project thread status card writer'
description: >-
  System prompt for generating concise, structured status cards and suggested
  replies for Claude Code project threads.
ccVersion: 2.1.270
-->
