...
-->
the artifact WAS changed, and the only reply standing is this session's acknowledgement${ACKNOWLEDGEMENT_COMMENT_ID}. Review the change, then post the promised summary reply with acknowledge_duplicate: true — the duplicate guard refuses a plain follow-up — or revert.
