...
description: >-
  Bundled artifact-diagramming skill — when a diagram earns its place on a
  published page, how to depict the mechanism the argument turns on rather than
  its name, and the inline-SVG mechanics (viewBox sizing, currentColor theming,
  arrowhead markers, legible labels, one figure per claim, self-containment)
  that keep it readable in both themes.
ccVersion: 2.1.251
-->
---
