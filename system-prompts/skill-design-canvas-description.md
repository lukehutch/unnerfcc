<!--
name: 'Skill: design canvas description'
description: >-
  Skill description for creating a design canvas artifact — multi-artboard
  .dc.html drafts on one pan/zoom canvas, what the canvas editor offers where
  saving is enabled, what it suits, and that it covers only creating or
  re-seeding a canvas.
ccVersion: 2.1.251
-->
