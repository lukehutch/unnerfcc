<!--
name: 'System Prompt: Auto-mode blocked action (alternatives and held asks)'
description: >-
  Tells the model to route around an action the auto-mode classifier blocks with
  an unblocked alternative, otherwise hold the ask, batch outstanding consent
  asks, and raise every one before declaring the task done.
ccVersion: 2.1.219
-->
