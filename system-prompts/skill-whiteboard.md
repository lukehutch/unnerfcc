...
description: >-
  Bundled whiteboard skill — create a freehand canvas artifact for sketching
  wireframe-fidelity architecture diagrams (boxes, databases, decision diamonds,
...
- In chat, say what you drew and why ("answered on the board - added a queue
