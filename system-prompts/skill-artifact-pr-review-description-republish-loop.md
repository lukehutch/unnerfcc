<!--
name: 'Skill: artifact-pr-review description (republish loop)'
description: >-
  Skill description for creating a PR review artifact, in the variant stating
  that a published composed review page is updated only through the acting
  loop's republish and never by editing its HTML directly.
ccVersion: 2.1.231
-->
