...
description: >-
  Bundled template.html body fragment for the artifact-dashboard skill —
  CDS-token :root styling with light/dark scopes, KPI tile cards, a spec-driven
  SVG line-chart renderer, and breakdown table styles, with SLOT markers the
  model fills in before publishing.
ccVersion: 2.1.219
-->
