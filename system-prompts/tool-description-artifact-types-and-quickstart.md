<!--
name: 'Tool Description: Artifact types and quickstart workflow'
description: >-
  Explains how Claude uses quickstart to discover artifact types and design
  systems before creating new artifacts.
ccVersion: 2.1.272
-->
