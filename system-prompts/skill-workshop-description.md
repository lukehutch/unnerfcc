...
description: >-
  Skill description telling the model when to run an interactive decision
  workshop as a published Artifact, picking the reader's on-page decisions back
  up in the session and republishing until the reader kicks off the build.
ccVersion: 2.1.251
-->
