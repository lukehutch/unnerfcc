...
description: >-
  Describes the memory_write tool — whole-document overwrite semantics, what
  belongs in a memory, the if_version contract and how conflicts come back for
  merge, and the refusal to write secrets into a shared store.
ccVersion: 2.1.231
variables:
