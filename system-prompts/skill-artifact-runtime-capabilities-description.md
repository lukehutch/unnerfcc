...
description: >-
  Skill description telling the model when to load the artifact
  runtime-capability roster — live or connected data, state shared across
  viewers, handing the viewer a file, or a self-republishing page.
ccVersion: 2.1.231
-->
