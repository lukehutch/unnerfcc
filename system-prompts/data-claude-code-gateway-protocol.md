...
description: >-
  Reference for the wire contract between the Claude Code CLI and an enterprise
  gateway — OAuth device-flow sign-in and discovery, the /v1/messages inference
  path, managed settings, model discovery, and OTLP telemetry, with proxy header
