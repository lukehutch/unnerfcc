<!--
name: 'System Reminder: Memory updates diff block'
description: >-
  Informs the model of background memory updates while strictly forbidding
  echoing or quoting the machine-generated block.
ccVersion: 2.1.251
-->
<memory_updates>
