<!--
name: 'Agent Prompt: Artifact comment thread moved handling'
description: >-
  Instructs the model how to address a comment thread that its author moved to a
  different part of an artifact.
ccVersion: 2.1.272
-->
