...
description: >-
  Bundled template.html body fragment for the artifact-data-table skill —
  light/dark paint tokens with a print-light override, sticky sortable table
  head, filter box, and a JS renderer over an inline row array, with SLOT
  markers the model fills before publishing.
ccVersion: 2.1.219
-->
