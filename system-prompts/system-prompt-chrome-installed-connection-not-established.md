<!--
name: 'System Prompt: Chrome installed, connection not established'
description: >-
  Injected notice that the extension installed but the browser connection could
  not be established this session.
ccVersion: 2.1.219
-->
