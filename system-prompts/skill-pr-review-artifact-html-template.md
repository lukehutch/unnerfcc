<!--
name: 'Skill: pr-review artifact HTML template'
description: >-
  Bundled HTML shell the model fills in to publish a shareable PR-review
  artifact page — design tokens, the synthesis/your-call/followups/files
  sections with named SLOT comments, PR-string escaping rules, and the baked
  decision-pill and approve-stamp scripts that republish the user's calls for
  the review session to read
ccVersion: 2.1.232
-->
